...
CREATE SERVER testserver1 FOREIGN DATA WRAPPER jdbc2_fdw;
CREATE SERVER loopback FOREIGN DATA WRAPPER jdbc2_fdw
...
CREATE FUNCTION jdbc2_fdw_abs(int) RETURNS int AS $$
BEGIN
RETURN abs($1);
END
...
EXPLAIN (VERBOSE, COSTS false) SELECT * FROM ft1 t1 WHERE t1.c1 = jdbc2_fdw_abs(t1.c2);
